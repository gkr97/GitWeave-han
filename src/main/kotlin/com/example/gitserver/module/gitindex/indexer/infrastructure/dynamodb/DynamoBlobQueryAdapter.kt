package com.example.gitserver.module.gitindex.indexer.infrastructure.dynamodb
...
class DynamoBlobQueryAdapter(
     ...
     * @return 확장자별 개수 맵
     */
    override fun countBlobsByExtension(repoId: Long): Map<String, Int> {
