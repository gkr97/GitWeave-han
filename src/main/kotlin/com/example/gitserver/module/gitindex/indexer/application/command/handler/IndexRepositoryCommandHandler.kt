package com.example.gitserver.module.gitindex.indexer.application.command.handler

import com.example.gitserver.module.gitindex.indexer.application.command.IndexRepositoryCommand
...
import com.example.gitserver.module.gitindex.indexer.application.internal.ScanDiff
import com.example.gitserver.module.gitindex.indexer.application.internal.TreeScanIndexer
...
import com.example.gitserver.module.gitindex.shared.domain.event.IndexingFailurePublisher
...
import com.example.gitserver.module.gitindex.shared.exception.GitCommitParseException
import com.example.gitserver.module.gitindex.shared.exception.GitHeadNotFoundException
import com.example.gitserver.module.gitindex.shared.exception.GitRepositoryOpenException
...
class IndexRepositoryCommandHandler(
    ...
    private fun finalizeCommit(
        ...
        commit: RevCommit,
        commitVo: Commit,
        result: com.example.gitserver.module.gitindex.indexer.application.internal.IndexFailures,
        branch: String,
