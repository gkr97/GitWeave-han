...
class RepositoryAccessResolver(
    ...
    @SchemaMapping(typeName = "RepositoryResponse", field = "isBookmarked")
    fun isBookmarked(repository: RepoDetailResponse, @AuthenticationPrincipal user: CustomUserDetails?): Boolean =
        repositoryQueryService.isBookmarked(repository.id, user?.getUserId())
