...
import com.example.gitserver.module.repository.application.command.handler.BranchCommandHandler
...
class BranchRestController(
    private val branchCommandHandler: BranchCommandHandler,
    ...
    fun createBranch(
        ...
        val branchId = branchCommandHandler.handle(
            CreateBranchCommand(
                repositoryId = repoId,
